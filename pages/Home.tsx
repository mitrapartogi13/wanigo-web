    ...
    <div className="w-full overflow-hidden -mt-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-bold tracking-wide text-sky-100 uppercase">Revolutionizing Waste Management</span>
              </motion.div>
              
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] mb-6 tracking-tight">
                Smart Cities Start with <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-200 to-white">Smart Waste</span>
              </h1>
              
              <p className="text-lg md:text-xl text-sky-100 mb-10 leading-relaxed font-medium">
                WANIGO! connects Waste Banks and Households through an AI-driven digital ecosystem. We optimize logistics, predict volumes, and reward sustainability.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/about" className="group bg-white text-[#0A5AEB] px-8 py-4 rounded-2xl font-bold transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center">
                  Discover Our Tech
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/contact" className="px-8 py-4 rounded-2xl font-bold text-white bg-white/10 border-2 border-white/20 hover:bg-white/20 transition-all flex items-center justify-center backdrop-blur-sm">
                  Partner With Us
                </Link>
              </div>
              ...
              <div className="mt-12 flex items-center gap-6 text-sky-200/80">
                <div className="flex -space-x-3">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="w-10 h-10 rounded-full border-2 border-[#0A5AEB] bg-slate-200 overflow-hidden">
                       <img src={`https://picsum.photos/100/100?random=${i+20}`} alt="User" className="w-full h-full object-cover" />
                    </div>
                  ))}
                </div>
                <div className="text-sm font-medium">
                  <span className="text-white font-bold block">Trusted by 100+ Partners</span>
                  <span className="text-sky-200">Across Surabaya & East Java</span>
                </div>
              </div>
            </motion.div>
            ...
            >
               <div className="relative z-10 bg-white/10 backdrop-blur-xl p-3 rounded-[2.5rem] shadow-2xl border border-white/20">
                 <img 
                   ...
                   className="rounded-[2rem] w-full h-auto object-cover shadow-inner opacity-90 hover:opacity-100 transition-opacity"
                 />
                 ...
                 >
                   ...
                   <div>
                     ...
                     <p className="text-lg font-bold text-slate-900">+45% Optimized</p>
                   </div>
                 </motion.div>
                 ...
                 >
                   ...
                   <div>
                     <p className="text-xs text-slate-500 font-bold uppercase">Total Waste</p>
                     <p className="text-lg font-bold text-slate-900">10.5 Tons</p>
                   </div>
                 </motion.div>
               </div>
            </motion.div>
      ...
      <section className="py-24 bg-slate-50 relative">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <span className="text-[#0A5AEB] font-extrabold tracking-widest uppercase text-xs mb-2 block">Our Solutions</span>
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">End-to-End Waste Ecosystem</h2>
            <p className="text-slate-500 text-lg">
              We provide a seamless platform connecting households, waste collectors, and recycling centers with cutting-edge technology.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            >
              <span className="text-[#0A5AEB] font-extrabold tracking-widest uppercase text-xs">Why Choose WANIGO?</span>
              <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mt-3 mb-8">Empowering Communities, Protecting Earth.</h2>
              ...
              <div className="space-y-8">
                {VALUES.map((value, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-[#0A5AEB] transition-colors">{value.title}</h4>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-4xl md:text-6xl font-extrabold text-white mb-8 tracking-tight">Ready to Make an Impact?</h2>
            <p className="text-sky-100 max-w-2xl mx-auto mb-10 text-xl font-medium">
              Join the revolution of digital waste management. Whether you're a Waste Bank Unit or a household, we have the solution for you.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
               <Link to="/contact" className="bg-white text-[#0A5AEB] px-10 py-4 rounded-full font-bold shadow-2xl hover:shadow-white/20 hover:scale-105 transition-all flex items-center justify-center">
                Start Collaboration
                <ArrowRight className="ml-2 w-5 h-5" />
              </Link>
               <Link to="/about" className="bg-white/10 backdrop-blur-md text-white border border-white/30 px-10 py-4 rounded-full font-bold hover:bg-white/20 hover:scale-105 transition-all">
                Read Our Story
              </Link>
            </div>
          </motion.div>
